...
The people who can merge PRs and cut releases for
`iso20022-readiness-suite-mcp` and the sibling packages in the ISO 20022 MCP
Suite. See [`GOVERNANCE.md`](GOVERNANCE.md) for roles, decision making, and how
to become a maintainer — we are actively looking for a second one.
